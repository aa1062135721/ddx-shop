...
<!--				</view>-->
		...
		<view class="info-box goods-info">
			...
			<view class="promise">
				温馨提示：订单已恢复发货，我们将按照下单顺序进行发货，偏远地区（新疆、西藏、内蒙古、青海以及港澳台等地区）不包邮或不发货，需单独联系客服补邮费才可发出。受疫情影响物流受限，北京部分地区已停发，请谅解。
			</view>
		</view>
		...
		<div class="cross-border-goods" v-if="goodsInfo.mold_id === 1">
			<view class="title">
				...
				跨境购商品不支持无理由退货和拒签，因疫情原因，发货及到货时效均有延迟，介意请慎拍。（保税商品预计在2-3个工作日送达，直邮商品预计45个工作日以上送达。）按照国家新政对跨境商品征收跨境综合税。跨境购订单需要顾客保持信息一致，要求顾客支付人姓名、收货人姓名、实名认证的姓名一致。
			</view>
